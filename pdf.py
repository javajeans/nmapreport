...
def reportPDFView(request):
	...
	for ik in o['host']:
		...
		if scanmd5 in cvehost:
			if addressmd5 in cvehost[scanmd5]:
				...
				r['toc'] += '&nbsp; &nbsp; &nbsp; &nbsp; <a href="#cvelist'+addressmd5+'">CVE 列表</a><br>'
	...
	'		<div class="col s3"><b class="blue-text" style="font-size:24px;">开启的HOST</b><br><span style="color:#999;font-size:32px;">'+str(counters['hostsup'])+'</span></div>'+\
	'		<div class="col s3" style="border-left:solid #ccc 1px;"><b class="blue-text" style="font-size:24px;">端口</b><br><span style="color:#999;font-size:32px;">'+str(counters['pc']+counters['po']+counters['pf'])+'</span></div>'+\
